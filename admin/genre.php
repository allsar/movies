    ...
    <div class="content-wrapper container-xxxl p-0">
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                <a href="genre_create.php" class="btn btn-primary"> Create</a>
            </div>
        </div>
                            ...
                            <table class="table">
                                ...
                                <?php foreach ($genres as $genre) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="./genre_edit.php?id=<?= $genre['id'] ?>" class="btn btn-sm btn-secondary">Edit</a>
                                            <form action="./php/genres/delete.php" method="post" class="d-inline-block">
