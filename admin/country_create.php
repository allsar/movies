                ...
                <div class="row">
                    <div class=" col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form form-horizontal" action="./php/country/create.php" method="post">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="first-name" class="form-control" name="name" placeholder="Country Name" />
                                                </div>
                                            </div>
                                        </div>
