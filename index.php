...
$db = new DB();
$conn = $db->getDB();
$movies = $conn->query("select m.id, m.title, m.rate, m.description, g.name as genre, m.quality, m.age, CONCAT_WS('', './img/movies/', m.image) as img
from movies m
join categories c on m.category_id = c.id
join genres g on m.genre_id = g.id
join countries c2 on m.country_id = c2.id
order by m.id desc limit 10")->fetch_all(MYSQLI_ASSOC);
//var_dump($movies);
//die();
?>
                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    <h3 class="card__title"><a href="details1.php?id=<?= $movie['id'] ?>"><?= $movie['title'] ?></a></h3>
