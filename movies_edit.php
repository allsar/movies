                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form form-horizontal" action="./php/movies/edit.php" method="post"
                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" id="description" class="form-control"
                                                           name="description" placeholder="Description"  value="<?= $movie['description']; ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-2">
                                                    <label class="col-form-label"
                                                           for="realise_date">Realise_date</label>
                                                </div>
                                                <div class="col-sm-10">
                                                    <input type="date" id="realise_date" class="form-control"
                                                           name="realise_date"  value="<?= $movie['realise_date']; ?>" placeholder="Realise-date"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" id="age" class="form-control" name="age"
                                                           placeholder="Age"  value="<?= $movie['age']; ?> "/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" id="quality" class="form-control" name="quality"
                                                           placeholder="Quality"  value="<?= $movie['quality']; ?> "/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" id="run_time" class="form-control"
                                                           name="run_time" placeholder="Run-time" value="<?= $movie['run_time']; ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <img src="./app-assets/images/movies/<?= $movie['image']; ?>" alt="" width="100px" height="100px">
                                                    <input type="file" id="image" class="form-control" name="image"
                                                           placeholder="Choose image" value="<?= $movie['image']; ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-2">
                                                    <label class="col-form-label"
                                                           for="select2-multiple">Category</label>
                                                </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="select2 form-select" id="select2-multiple"
                                                        ...
                                                        <?php foreach ($categories as $category) { ?>
                                                            <option value="<?= $category['id'] ?>" <?php if ($category['id'] == $movie['category_id'] ){
                                                                echo 'selected';
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="select2 form-select" id="select2-multiple"
                                                        ...
                                                        <?php foreach ($countries as $country) { ?>
                                                            <option value="<?= $country['id'] ?>" <?php if ($country['id'] == $movie['country_id'] ){
                                                                echo 'selected';
                                                            }?>
                                                            ><?= $country['name'] ?></option>
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="select2 form-select" id="select2-multiple"
                                                        ...
                                                        <?php foreach ($genres as $genre) { ?>
                                                            <option value="<?= $genre['id'] ?>" <?php if ($genre['id'] == $movie['genre_id'] ){
                                                                echo 'selected';
                                                            }?>><?= $genre['name'] ?></option>
